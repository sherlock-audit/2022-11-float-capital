...
contract MarketTieredLeverageSenarioOne is FloatTest {
  ...
  function checkMarketPoolsAtCheckpointA() public {
    // check pools
    {
      ...
      assertEq(shortPoolValue, 100e18, "Checkpoint A short side was not seeded correctly");
    ...
    }
    {
      ...
      assertEq(longPoolValue, 100e18, "Checkpoint A long side was not seeded correctly");
    ...
    }
    {
      ...
      assertEq(floatPoolValue, 100e18, "Checkpoint A float side was not seeded correctly");
      // assertEq(floatPoolLeverage, 0, "Checkpoint A floatPoolLeverage should be 0x initially");
  ...
  function checkMarketPoolsAtCheckpointB() public {
    // check pools
    {
      ...
      uint256 shortPoolOddBatchedRedeem = market.get_odd_batchedAmountPoolToken_redeem(IMarketCommon.PoolType.SHORT, POOL_INDEX);
      uint256 shortPoolValue = market.get_pool_value(IMarketCommon.PoolType.SHORT, POOL_INDEX);
      assertEq(shortPoolValue, 90e18, "Checkpoint B short side was not updated correctly");
    ...
    }
    {
      ...
      uint256 longPoolOddBatchedRedeem = market.get_odd_batchedAmountPoolToken_redeem(IMarketCommon.PoolType.LONG, POOL_INDEX);
      uint256 longPoolValue = market.get_pool_value(IMarketCommon.PoolType.LONG, POOL_INDEX);
      assertEq(longPoolValue, 110e18, "Checkpoint B long side was not updated correctly");
      assertEq(longPoolLeverage, 1e18, "Checkpoint B longPoolLeverage should be 1x");
      assertEq(longPoolEvenBatchedDeposit, 0, "Checkpoint B longPoolEvenBatchedDeposit should be 0");
    ...
    }
    {
      ...
      uint256 floatPoolOddBatchedRedeem = market.get_odd_batchedAmountPoolToken_redeem(IMarketCommon.PoolType.FLOAT, POOL_INDEX);
      uint256 floatPoolValue = market.get_pool_value(IMarketCommon.PoolType.FLOAT, POOL_INDEX);
      assertEq(floatPoolValue, 100e18, "Checkpoint B float side was not updated correctly");
      // assertEq(floatPoolLeverage, -0.2e18, "Checkpoint B floatPoolLeverage should be 0.2x");
  ...
  function checkMarketPoolsAtCheckpointC() public {
    // check pools
    {
      ...
      assertEq(shortPoolValue, 99e18, "Checkpoint C short side was not updated correctly");
    ...
    }
    {
      ...
      assertEq(longPoolValue, 99e18, "Checkpoint C long side was not updated correctly");
    ...
    }
    {
      ...
      assertEq(floatPoolValue, 102e18, "Checkpoint C float side was not updated correctly");
      // assertEq(floatPoolLeverage, 0, "Checkpoint C floatPoolLeverage should be 0x");
  ...
  function checkMarketPoolsAtCheckpointD() public {
    // check pools
    {
      ...
      assertApproxEqAbs(shortPoolValue, 108e18, 9, "Checkpoint D short side was not updated correctly");
    ...
    }
    {
      ...
      assertApproxEqAbs(longPoolValue, 90e18, 9, "Checkpoint D long side was not updated correctly");
    ...
    }
    {
      ...
      assertEq(floatPoolValue, 102e18, "Checkpoint D float side was not updated correctly");
      // assertEq(floatPoolLeverage, 0.176470588235294117e18, "Checkpoint D floatPoolLeverage should be 0.176...x");
  ...
  function checkMarketPoolsAtCheckpointE() public {
    // check pools
    {
      ...
      assertApproxEqAbs(shortPoolValue, 118.8e18, 15, "Checkpoint E short side was not updated correctly");
    ...
    }
    {
      ...
      assertApproxEqAbs(longPoolValue, 81e18, 9, "Checkpoint E long side was not updated correctly");
    ...
    }
    {
      ...
      assertApproxEqAbs(floatPoolValue, 100.2e18, 7, "Checkpoint E float side was not updated correctly");
      // assertEq(floatPoolLeverage, 0.377245508982035927e18, "Checkpoint E floatPoolLeverage should be 0.377245508x");
  ...
  /// @dev this test follows this excalidraw image exactly: https://app.excalidraw.com/l/2big5WYTyfh/AsMLUl3D5WY
  function FIX_ME_testMarketSimpleTranchScenarioOne() public {
    user1 = getFreshUser();
    user2 = getFreshUser();
    user3 = getFreshUser();
