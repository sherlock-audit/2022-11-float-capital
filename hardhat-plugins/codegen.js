  ...
  config.codeGen = Object.assign(
    {
      ast: {
        ...
        files: [
          {
            contractName: "OracleManagerFixedEpoch",
            fullPath: "contracts/oracles/template/OracleManagerFixedEpoch.sol"
          },
          {
            contractName: "MarketTieredLeverage",
            fullPath: "contracts/market/template/MarketTieredLeverage.sol"
          }
        ],
      }
